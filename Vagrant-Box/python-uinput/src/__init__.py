...
_libsuinput_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "_libsuinput" + '.cpython-311-x86_64-linux-gnu' + sysconfig.get_config_var('SHLIB_SUFFIX')))
# SO is deprecated: https://github.com/python/cpython/issues/63754 sysconfig.get_config_var('SHLIB_SUFFIX')
